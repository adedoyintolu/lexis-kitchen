...
export const pricingCategoriesBackup: PricingCategory[] = [
  {
    slug: "nibbles",
    label: "Nibbles",
    ...
    items: [
      { name: "mini sliders", largePackPrice: 3, smallPackPrice: 0 },
      { name: "mini sandwich", largePackPrice: 3, smallPackPrice: 0 },
      { name: "Pinwheels", largePackPrice: 3, smallPackPrice: 0 },
      { name: "mini meat pies", largePackPrice: 3, smallPackPrice: 0 },
      { name: "Mini turkey sliders", largePackPrice: 3, smallPackPrice: 0 },
      { name: "Pasta Cups", largePackPrice: 4, smallPackPrice: 0 },
      { name: "Puff puff", largePackPrice: 3, smallPackPrice: 0 },
      { name: "Samosas", largePackPrice: 3, smallPackPrice: 0 },
      { name: "Spring rolls", largePackPrice: 3, smallPackPrice: 0 },
      { name: "prawn spring rolls", largePackPrice: 3, smallPackPrice: 0 },
      { name: "Mosa", largePackPrice: 3, smallPackPrice: 0 },
      { name: "Wings", largePackPrice: 3, smallPackPrice: 0 },
      { name: "beef kebab", largePackPrice: 3, smallPackPrice: 0 },
      { name: "chicken kebab", largePackPrice: 3, smallPackPrice: 0 },
      { name: "goat meat pepper soup", largePackPrice: 3, smallPackPrice: 0 },
      { name: "breadrolls or butter", largePackPrice: 3, smallPackPrice: 0 },
      { name: "fruit salad", largePackPrice: 3, smallPackPrice: 0 },
      { name: "peppered kpomo", largePackPrice: 3, smallPackPrice: 0 },
    ],
  },
  {
    slug: "mains-premium",
    ...
    items: [
      ...
      { name: "Salmon", largePackPrice: 12, smallPackPrice: 0 },
      { name: "Lamb chops", largePackPrice: 20, smallPackPrice: 0 },
      {
        name: "Steamed  coconut Basmati Rice",
        largePackPrice: 150,
        smallPackPrice: 0,
      },
      { name: "Creamy Catfish nugget", largePackPrice: 0, smallPackPrice: 0 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Seafood sauce", largePackPrice: 150 },
    ],
  },
  {
    slug: "stews",

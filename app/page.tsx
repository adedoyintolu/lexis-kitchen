        ...
        <main>
          ...
          <section className="py-9 md:py-14">
            <div className="w-[min(calc(100%-1.5rem),76rem)] md:w-[min(calc(100%-3rem),76rem)] mx-auto grid gap-4 md:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] md:gap-6">
              <FadeIn className="rounded-[1.75rem] p-[1.4rem] border border-[color:var(--color-line)] bg-[rgba(255,255,255,0.72)] [box-shadow:0_20px_60px_rgba(49,40,33,0.08)]">
                <p className="m-0 text-[color:var(--color-accent-soft)] uppercase tracking-[0.16em] text-[0.75rem] font-bold">
                  Lexi&apos;s Kitchen Catering
                </p>
                <h1 className="mt-2 mb-4 font-[family-name:var(--font-display)] text-[clamp(3rem,10vw,6.2rem)] leading-[0.95] tracking-[-0.03em]">
                  Elegant event catering for intimate tastings, polished
                  corporate tables, and memorable celebrations.
                </h1>
                <p className="m-0 mb-[1.4rem] text-[color:var(--color-text-soft)] leading-[1.7]">
              ...
              <FadeIn delay={0.12}>
                <div className="h-full rounded-[1.75rem] p-[1.4rem] grid gap-5 border border-[color:var(--color-line)] bg-[color:var(--color-surface)] [box-shadow:0_20px_60px_rgba(49,40,33,0.08)]">
                  <p className="m-0 text-[color:var(--color-accent-soft)] uppercase tracking-[0.16em] text-[0.75rem] font-bold">
                    At a glance
                  </p>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="grid gap-[0.35rem] p-4 rounded-[1.2rem] bg-[color:var(--color-surface-strong)] border border-[color:var(--color-line)]">
                  ...
                  <div className="grid gap-[0.15rem] text-[0.95rem] text-[color:var(--color-text-soft)]">
          ...
          {/* Services */}
          <section id="services" className="py-[4.5rem]">
          ...
          <section
            id="pricing"
            className="py-[4.5rem] bg-[rgba(255,255,255,0.45)] border-t border-b border-[color:var(--color-line)]"
          >
          ...
          {/* Process + Inquiry */}
          <section id="process" className="py-[4.5rem]">
